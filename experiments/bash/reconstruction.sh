...
#
# @description:
# Bash script for evaluating reconstruction quality.
#
# Usage: bash reconstruction.sh
...
OUTPUT_PATH="${RESULT_BASE_PATH}/reconstruction"
...
for dataset in "${datasets[@]}"; do
  for backbone in "${backbones[@]}"; do
    accelerate launch $ACCELERATE_ARGS ./reconstruction.py \
      --dataset $dataset \
      --data_path $DATA_PATH \
